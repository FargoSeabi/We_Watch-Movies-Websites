...
<head>
    ...
    <link rel="stylesheet" href="/we_watch/style/profile.css">
    <script src="/we_watch/script/script.js" defer></script>
    <title>Profile</title>
</head>
...
<body>
    <div class="main">
        ...
        <div class="profile">
            ...
            <div class="form">
                <?php
                include $_SERVER["DOCUMENT_ROOT"]."/we_watch/server/connection.php";
                        ...
                        if($result->num_rows > 0) {
                            ...
                            <div class="form">
                                <section class="container">
                                    <form action="/we_watch/server/update.php" method="POST" class="form">
                                        <div class="input-box">
                                        ...
                                        <button> <a href="/we_watch/index.html">Log out</a></button>
