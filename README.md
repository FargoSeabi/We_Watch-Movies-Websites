...
2. Create a `movies` DB.
3. Create a `students` table with fields: id, name, surname, student_no, contact, module_code, email, password.
...
3. Start XAMPP.
4. Access the app at `http://localhost/we_watch`.
